...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                (
                    ...
                    binningBuffer,
                    imgBuffer,
                    out_means2D, # <<< RECEIVE new output
        ...
        # return color, radii, depth, out_means2D.detach() # <<< RETURN new output
        return color, radii, depth, out_means2D# <<< RETURN new output

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_depth, grad_out_means2D):
        # 修改完别忘了build!!!
